...
CREATE TABLE Warehouses( 
    WarehouseId     NUMBER(5)          GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE Orders (
    OrderId         NUMBER(5)          GENERATED BY DEFAULT AS IDENTITY,
    ProductId       NUMBER(5)          REFERENCES Products (ProductId),
    CustomerId      NUMBER(5)          REFERENCES Customers (CustomerId),
...
-- Warehouses (This seems redundant so stopped for now)
